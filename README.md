...
[`● fltMgr.sys - Filesystem Filter Manager	3`](#fltmgr.sys---filesystem-filter-manager)

[`● KSecdD.sys - Kernel Security Support Provider Driver	4`](#ksecdd.sys---kernel-security-support-provider-driver)

[`● ntoskrnl.exe - NT Kernel & System	4`](#ntoskrnl.exe---nt-kernel-&-system)

[`● tbs.sys - Kernel TPM API	6`](#tbs.sys---kernel-tpm-api)

[**`Exports	6`](#exports)**

[`● entry - DriverEntry	6`](#entry---driverentry)

[**`Strings (That were used in the driver’s functions)	6`](#strings-\(that-were-used-in-the-driver’s-functions\))**
...
[`● FC - FileCrypt functions	8`](#fc---filecrypt-functions)

[`● Kappx - Windows Apps packages helper functions	8`](#kappx---windows-apps-packages-helper-functions)

[`● m - C memory manipulation functions	9`](#m---c-memory-manipulation-functions)

[`● Mc - Logging functions	9`](#mc---logging-functions)

[`● Rtl - String manipulation functions	9`](#rtl---string-manipulation-functions)

[`● StSec - Windows security	9`](#stsec---windows-security)

[`● write_ - C style Character manipulation functions	10`](#write_---c-style-character-manipulation-functions)

[**`Registered Operations	10`](#registered-operations)**

[**`Flags	10`](#flags)**

[**`Custom Data Types	11`](#custom-data-types)**

[`● CUSTOM_FC_BCRYPT_DATA	11`](#custom_fc_bcrypt_data)

[`● CUSTOM_FC_VOLUME_CONTEXT	12`](#custom_fc_volume_context)

[`● CUSTOM_FC_BCRYPT_KEY_DATA	13`](#custom_fc_bcrypt_key_data)

[`● CUSTOM_FC_STREAM_CONTEXT	14`](#custom_fc_stream_context)

[`● CUSTOM_FC_CREATE_CONTEXT	15`](#custom_fc_create_context)

[`● CUSTOM_FC_DECRYPT_PARAMS	16`](#custom_fc_decrypt_params)

[`● CUSTOM_FC_READ_CONTEXT	17`](#custom_fc_read_context)

[`● CUSTOM_FC_WRITE_CONTEXT	18`](#custom_fc_write_context)

[`● CUSTOM_FC_STSEC_CACHE_TABLE_ENTRY	18`](#custom_fc_stsec_cache_table_entry)

[`● CUSTOM_FC_CHAMBER_DATA	19`](#custom_fc_chamber_data)

[`● CUSTOM_FC_STSEC_SEC_DESC_CACHE_LIST_ENTRY	20`](#custom_fc_stsec_sec_desc_cache_list_entry)

[`● CUSTOM_FC_STSEC_FOLDER_PROP_CACHE_LIST_ENTRY	21`](#custom_fc_stsec_folder_prop_cache_list_entry)

[**`Pool Tags	22`](#pool-tags)**

[**`Registries	23`](#registries)**

[`\Registry\Machine\System\ControlSet001\Services\`](#\\registry\\machine\\system\\controlset001\\services\\-filecrypt\\)  
[`FileCrypt\	23`](#\\registry\\machine\\system\\controlset001\\services\\-filecrypt\\)

[`\Registry\Machine\Software\Microsoft\SecurityManager\StorageCardProfiles\Chambers\	24`](#\\registry\\machine\\software\\microsoft\\securitymanager\\storagecardprofiles\\chambers\\)

[`\Registry\Machine\Software\Microsoft\StorageSec\`](#\\registry\\machine\\software\\microsoft\\storagesec\\-encrypt\\)  
[`Encrypt\	24`](#\\registry\\machine\\software\\microsoft\\storagesec\\-encrypt\\)

[`\Registry\Machine\System\ControlSet001\Control\StSec\SecurityDescriptors\	25`](#\\registry\\machine\\system\\controlset001\\control\\stsec\\securitydescriptors\\)

[`\Registry\Machine\System\ControlSet001\Control\StSec\\FolderProperties\	26`](#\\registry\\machine\\system\\controlset001\\control\\stsec\\\\folderproperties\\)

[`\Registry\Machine\Software\Microsoft\Windows\`](#\\registry\\machine\\software\\microsoft\\windows\\-currentversion\\appx\\)  
[`CurrentVersion\Appx\	26`](#\\registry\\machine\\software\\microsoft\\windows\\-currentversion\\appx\\)

[`\Registry\Machine\Software\Microsoft\Windows\`](#\\registry\\machine\\software\\microsoft\\windows\\-currentversion\\appx\\packagesidref\\)  
[`CurrentVersion\Appx\PackageSidRef\	27`](#\\registry\\machine\\software\\microsoft\\windows\\-currentversion\\appx\\packagesidref\\)
...
* `Driver digital signatures`  
  ...
  * `Tag:`  
    **`BCCB808BCB9EF42957F660EB26709AEC85712F875225AB7AF77C79170F05A1FD`**  
  * `Thumbprint:`   
    **`bc cb 80 8b cb 9e f4 29 57 f6 60 eb 26 70 9a ec 85 71 2f 87 52 25 ab 7a f7 7c 79 17 0f 05 a1 fd`**

*  `File SHA256 hash (https://emn178.github.io/online-tools/sha256_checksum.html):`  
...
* #### **`fltMgr.sys`** `- Filesystem Filter Manager` {#fltmgr.sys---filesystem-filter-manager}
...
* #### **`KSecdD.sys`** `- Kernel Security Support Provider Driver` {#ksecdd.sys---kernel-security-support-provider-driver}
...
* #### **`ntoskrnl.exe`** `- NT Kernel & System` {#ntoskrnl.exe---nt-kernel-&-system}
...
* #### **`tbs.sys`** `- Kernel TPM API` {#tbs.sys---kernel-tpm-api}
...
* #### **`entry`** `- DriverEntry` {#entry---driverentry}

# `Strings (That were used in the driver’s functions)` {#strings-(that-were-used-in-the-driver’s-functions)}
...
**`No progress | Some progress | Major coverage | Done | Ignored`**

* #### **`DriverEntry`** {#driverentry}

* #### **`entry`** {#entry}

* #### **`FC`** `- FileCrypt functions` {#fc---filecrypt-functions}
...
* #### **`Kappx`** `- Windows Apps packages helper functions` {#kappx---windows-apps-packages-helper-functions}
...
* #### **`m`** `- C memory manipulation functions` {#m---c-memory-manipulation-functions}

  * `mbtowc - Fully typed`  
  * `memcpy - Has comments, no need to go further`  
  * `memset - Same as above`

* #### **`Mc`** `- Logging functions` {#mc---logging-functions}
...
* #### **`Rtl`** `- String manipulation functions` {#rtl---string-manipulation-functions}
...
* #### **`StSec`** `- Windows security` {#stsec---windows-security}
...
* #### **`write_`** `- C style Character manipulation functions` {#write_---c-style-character-manipulation-functions}
...
* ### `CUSTOM_FC_BCRYPT_DATA` {#custom_fc_bcrypt_data}
...
* ### `CUSTOM_FC_VOLUME_CONTEXT` {#custom_fc_volume_context}
...
* ### `CUSTOM_FC_BCRYPT_KEY_DATA` {#custom_fc_bcrypt_key_data}
...
* ### `CUSTOM_FC_STREAM_CONTEXT` {#custom_fc_stream_context}
...
* `Cleanup function that frees the chamber Id using FCpFreeChamberId and securely destroys encryption key data via FCpEncStreamCleanup.`
...
* ### `CUSTOM_FC_CREATE_CONTEXT` {#custom_fc_create_context}
...
* ### `CUSTOM_FC_DECRYPT_PARAMS` {#custom_fc_decrypt_params}
...
* ### `CUSTOM_FC_READ_CONTEXT` {#custom_fc_read_context}
...
* ### `CUSTOM_FC_WRITE_CONTEXT` {#custom_fc_write_context}
...
* ### `CUSTOM_FC_STSEC_CACHE_TABLE_ENTRY` {#custom_fc_stsec_cache_table_entry}
...
* ### `CUSTOM_FC_CHAMBER_DATA` {#custom_fc_chamber_data}
...
* ### `CUSTOM_FC_STSEC_SEC_DESC_CACHE_LIST_ENTRY` {#custom_fc_stsec_sec_desc_cache_list_entry}
...
* ### `CUSTOM_FC_STSEC_FOLDER_PROP_CACHE_LIST_ENTRY` {#custom_fc_stsec_folder_prop_cache_list_entry}
...
* **`0x78764346`** `- “FCvx” (Volume Context)`  
  * `ContextRegistration @ 1c0006018`  
* **`0x78734346`** `- “FCsx” (Stream Context)`  
  * `ContextRegistration @ 1c0006050`  
* **`0x70764346`** `- “FCvp”`  
  * `FCInstanceSetup`  
* **`0x69764346`** `- “FCvi”`  
  * `FCInstanceSetup`  
...
### `\Registry\Machine\System\ControlSet001\Services\` `FileCrypt\` {#\registry\machine\system\controlset001\services\-filecrypt\}

`Used in: Injected into the driver DriverEntry and passed to FCReadDriverParameters.`  
`Stored at the gRegistryPath global variable.`

`Keys and Values:`

* `“DebugTraceLevel”: Saved in global variable FcDebugTraceLevel. This is unused throughout the driver.`  
* `“EncryptMedia”: Used to decide whether to encrypt files in the media chambers (Music, Video, and Pictures) or not.`  
* `“EncryptAll”: Used to decide whether to encrypt files in the general chamber ({0b7992da-c5e6-41e3-b24f-55419b997a15}).`  
* `“BypassAccessChecks”: Used to decide whether to do an access check when creating a file. The access check is performed with the SeAccessCheck function, and if it fails, the driver attempts to change the create disposition. If this registry is positive, any attached volume will be marked as unsecured by removing the FILE_DEVICE_SECURE_OPEN characteristic from it.`  
* `“FilterEmulatedExternalDrive”: When the driver is attempting to attach to a volume, it is used to decide if the driver is allowed to attach to SD cards. If the registry is positive, the driver will also set the volume it is attached to be ‘removable media’.`

### `\Registry\Machine\Software\Microsoft\SecurityManager\StorageCardProfiles\Chambers\` {#\registry\machine\software\microsoft\securitymanager\storagecardprofiles\chambers\}

`Used in: StSecpCheckConditionalPolicy`
...
### `\Registry\Machine\Software\Microsoft\StorageSec\` `Encrypt\`  {#\registry\machine\software\microsoft\storagesec\-encrypt\}

`Used at: StSecpWriteSealedKeyBlob, StSecpOpenMasterKeyHandle, StSecpSealKeyTestHookSet`

`Keys and Values:`

* `“MK”: This key is used in StSecpWriteSealedKeyBlob after obtaining the registry handle from StSecpOpenMasterKeyHandle. It contains the sealed master key. The master key is also saved in the g_MasterKey.`  
* `“SkipSealKey”: a boolean value that indicates whether the driver needs to seal and unseal using the TPM (Trusted Platform Module) or whether it can just put it right in the “MK” registry without doing so.`

### `\Registry\Machine\System\ControlSet001\Control\StSec\SecurityDescriptors\` {#\registry\machine\system\controlset001\control\stsec\securitydescriptors\}

`Used in: StSecpInitializePolicyCache, StSecpGetSecurityDescriptorPolicy.`
...
`\Registry\Machine\System\ControlSet001\Control\StSec\`  
`SecurityDescriptors\`                  
`├── Documents\\`  
`│   ├── <PackageFamilyName>\\`  
`│   │   ├── PrivateData\\`  
...
### `\Registry\Machine\System\ControlSet001\Control\StSec\\FolderProperties\` {#\registry\machine\system\controlset001\control\stsec\\folderproperties\}

`Used in: StSecpInitializePolicyCache, StSecpGetFolderPropertyPolicy.`
...
### `\Registry\Machine\Software\Microsoft\Windows\` `CurrentVersion\Appx\` {#\registry\machine\software\microsoft\windows\-currentversion\appx\}

`Used in: KappxGetPackageRootPathForPackageFullName.`

`This is a core Windows AppX/UWP registry location that contains system-wide configuration for Windows Store applications.`

* `“PackageRoot”: contains the base filesystem path where all Windows Store applications are installed. Typically, this is “C:\Program Files\WindowsApps\”. This value is then cached in the g_PackageRoot (and g_PackageRootLength) global variables.`

### `\Registry\Machine\Software\Microsoft\Windows\` `CurrentVersion\Appx\PackageSidRef\` {#\registry\machine\software\microsoft\windows\-currentversion\appx\packagesidref\}

`Used in: KappxGetPackageSidFromPackageFamilyNameInRegistry`

`This registry location is specifically for Package SID resolution.`  
...
`This is used to get the security descriptor for the path that is passed to the pre-create callback.`